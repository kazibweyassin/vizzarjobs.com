              ...
              <Card>
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    {job.visaSponsorship && (
                      <Badge className="bg-amber-500 text-white border-0 font-medium text-sm px-3 py-1">
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-3">
                    <Badge variant="outline" className="bg-[#0F2C4C]/10 text-[#0F2C4C] border-[#0F2C4C]/20">
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-3">
                        <Briefcase className="w-5 h-5 text-[#0F2C4C]" />
                        <div>
                      ...
                      <div className="flex items-center gap-3">
                        <TrendingUp className="w-5 h-5 text-[#0F2C4C]" />
                        <div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-3">
                        <Globe className="w-5 h-5 text-[#0F2C4C]" />
                        <div>
                    ...
                    <ul className="space-y-3">
                      {job.requirements.map((requirement, index) => (
                        <li key={index} className="flex items-start gap-3">
                          <div className="flex-shrink-0 w-6 h-6 bg-[#0F2C4C]/10 rounded-full flex items-center justify-center mt-0.5">
                            <span className="text-[#0F2C4C] text-sm font-medium">{index + 1}</span>
                          </div>
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-3">
                      {job.techStack.map((tech, index) => (
                        <Badge key={index} variant="secondary" className="px-4 py-2 text-sm font-medium bg-[#0F2C4C]/10 text-[#0F2C4C] border-[#0F2C4C]/20 hover:bg-[#0F2C4C]/10">
                          {tech}
                        </Badge>
                      ))}
                    </div>
                    ...
                    {job.applicationUrl ? (
                      <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <h4 className="font-medium text-amber-900">External Application</h4>
                        </div>
                        ...
                        <a
                          ...
                          className="inline-flex items-center gap-2 bg-[#0F2C4C] hover:bg-[#1a3d63] text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200"
                        >
                      ...
                      <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <h4 className="font-medium text-amber-900">Application Method</h4>
                        </div>
                  ...
                  <div className="space-y-4">
                    ...
                    {job.applicationUrl ? (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-full bg-[#0F2C4C] hover:bg-[#1a3d63] text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2"
                      >
                        <ExternalLink className="w-4 h-4" />
                        Apply Now
                      </a>
                    ...
                    {job.company.website && (
                      <div className="flex items-center gap-2">
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-[#0F2C4C] hover:text-amber-600 text-sm"
                        >
                          Visit Website
                        </a>
                      </div>
