      ...
      <div className="flex min-h-full flex-col justify-center bg-gray-900 px-6 py-12 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <div className="text-center">
            <div className="w-16 h-16 rounded-xl bg-indigo-500/20 flex items-center justify-center mx-auto mb-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <Button
                ...
                className="flex w-full justify-center bg-indigo-500 hover:bg-indigo-400 text-white"
              >
